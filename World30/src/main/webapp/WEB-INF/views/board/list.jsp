...
<body>
            ...
            <table class="table">
               <thead>
                  <tr>
                     ...
                     <th class="th-center" style="width: 50%">글 제목</th>
  ...
  <ul class="pagination">
    ...
    <li>
      <a href="/board/list?curPage=${to.curPage <to.totalPage ? to.curPage +1 : totalPage }" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
           ...
           <form target="_blank" action="/board/searchlist" method="get">
             ...
             <input class="form-control" name="keyword">
                   ...
                   <button class="btn btn-danger">검 색</button>
