...
public class AjaxTestController {
	...
	public List<Map<String, Object>> at4(@RequestParam Map<String, Object> map) throws Exception, JsonMappingException, IOException {
	...
	@ResponseBody // @ResponseBody를 붙이면 ajax통신을 하는 애구나 라고 알게됨
